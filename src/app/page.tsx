...
const Home = () => {
  ...
  return (
    ...
    <main>
      <section id="main-section" className="border border-4 hero-section container mx-auto grid grid-cols-12 gap-2">
        <div className="border border-3 hero-title text-center col-start-3 col-span-8 py-12">
      ...
      <section id="graph-section" className="details-section">
        <div className='mx-5 border border-5'>
